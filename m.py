...
db = client['Kamisama']
users_collection = db['GANDI']
settings_collection = db['settings0']  # A new collection to store global settings
redeem_codes_collection = db['redeem_codes0']

# Bot Configuration
TELEGRAM_BOT_TOKEN = '7571243556:AAE9dPZcTKxvqxAXmyVm-DUQ4vJxPgdxMy8'
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*PAPA AGHORI KO FEEDBACK DENA VARNA BOT OFF!*", parse_mode='Markdown')
